...
class TurmasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turma" do
    assert_difference("Turma.count") do
      post turmas_url, params: { turma: { code: @turma.code, number: @turma.number, semester: @turma.semester, time: @turma.time } }
    end
  ...
  test "should update turma" do
    patch turma_url(@turma), params: { turma: { code: @turma.code, number: @turma.number, semester: @turma.semester, time: @turma.time } }
